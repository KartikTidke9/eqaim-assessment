  ...
  return (
    <div className="flex mx-12 mt-8 md:mt-24 md:mx-40 sm:mt-16 sm:mx-20 gap-7">
      ...
      <div className="w-full">
        ...
        <div className="flex flex-col items-center justify-center text-center mx-52 my-28">
          ...
          <div className="mt-8">
            <p className="mb-4 text-lg font-bold">There is no feedback yet.</p>
            <p className="text-xs opacity-50">
              Got a suggestion? Found a bug that needs to be squashed? We love
              hearing about new ideas to improve our app. Add Feedback
            </p>
          </div>
          <div className="mt-8">
            <Button
